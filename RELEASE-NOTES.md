# YUZ-TRA 1.5.0 — distribution indépendante d’évaluation

Télécharger **yuz-tra-1.5.0.zip** ci-dessous, pas l’archive « Source code ».
...
- Nouvel atelier commun : visuel à gauche, chaînes à droite, alignés en haut.
...
**Sauvegarder et tester sur staging. Pas d’approbation WordPress.org, pas de promesse
de traduction parfaite, pas de mise à jour automatique ni de support sous délai garanti.**
...
pas de réponses fournisseur simulées. Voir QA-1.5.0.md.
