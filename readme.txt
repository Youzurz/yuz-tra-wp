...
Development source and release automation are maintained publicly:

* GitHub: https://github.com/Youzurz/yuz-tra-wp
* GitLab: https://git.youzurz.com/yuz/yuz-tra-wp

Current connector status:

* LibreTranslate: available after explicit administrator configuration of an endpoint
...
translation providers. No external translation provider is enabled by default in
this WordPress.org build. Review your plugin settings before enabling those
integrations.

= What data is sent to LibreTranslate? =

When a site administrator configures and enables LibreTranslate, text selected
for translation and the requested source and target language codes are sent to
the endpoint configured by that administrator. No provider connection is
enabled by default.
