...
**yuz-tra-1.5.6.zip** dans « Assets ». Ne pas choisir « Source code.zip » : c’est
...
```sh
sha256sum -c yuz-tra-1.5.6.zip.sha256
```

Sur macOS : `shasum -a 256 yuz-tra-1.5.6.zip` et comparer avec le fichier de contrôle.
...
WordPress 7.1 et PHP 8.3. Vérifier la recette et les limites avant un site de production.
