...
if (!class_exists('YUZ_Plugin')) {
    ...
    global $wpdb;
        ...
        public static function load_textdomain(): void {
            $domain_path = dirname(plugin_basename(YUZ_TRA_PLUGIN_FILE)) . '/languages';

            foreach (['yuz_tra', 'yuz_translation', 'yuz-tra-wp'] as $domain) {
                load_plugin_textdomain($domain, false, $domain_path);
            }
        }
