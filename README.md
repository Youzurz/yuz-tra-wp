...
1. Sauvegarder la base et l’ancienne extension. Dans WordPress : Extensions → Ajouter → Téléverser, sélectionner `yuz-tra-1.5.0.zip`, installer puis activer. Pour une mise à jour, confirmer le remplacement de YUZ-TRA uniquement.
